        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (faces != null) {
                    ...
                    ArrayList<FloatBuffer> rectsList = new ArrayList<FloatBuffer>();
                    confidence = 0.0f;
                    ...
                    if (faces.length >= 0) {
                        ...
                        for (int c = 0; c < faces.length; c++) {
                            ...
                            //加载马赛克框数据，跟屏幕的方向无关
                            rectsList.addAll(OpenGLDrawRect.drawMosaicRect(
                                    isBackCamera,
                                    faces[c].rect,
                                    width,
                                    height));
                    ...
                    synchronized (mPointsMatrix) {
                        ...
                        //绘制马赛克框
                        mPointsMatrix.vertexBuffers = rectsList;
                    }
                    ...
                    mPointsMatrix.vertexBuffers = null;
                }
                isSuccess = false;
                if (!isTiming) {
